	...
	factory: (require) => {
		...
		*/
		function TimelineRail({ useSession, loadOlder = async () => {} }) {
			...
			const [chatVisible, setChatVisible] = (0, react.useState)(() => typeof document !== "undefined" && document.querySelector("[data-conversation-scroll]") !== null);
			(0, react.useEffect)(() => {
			...
			const marks = (0, react.useMemo)(() => {
				...
				const flushReply = () => {
					...
					if (last !== void 0) last.reply = replyParts.join("\n").replace(/\s+/g, " ").trim().slice(0, 160);
					replyParts = [];
				};
				for (const key of order) {
					...
					if (node.kind === "user") {
						...
						for (const block of blocks) if (block !== null && typeof block === "object" && block.kind === "text" && typeof block.text === "string") replyParts.push(block.text);
					}
				}
				flushReply();
				return result;
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							style: { display: "block" },
							children: hoveredMark.preview.length > 0 ? hoveredMark.preview + (hoveredMark.preview.length >= 80 ? "…" : "") : "（空消息）"
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							"data-timeline-reply": true,
							style: {
								display: "-webkit-box",
								WebkitLineClamp: 3,
							...
							children: hoveredMark.reply.length > 0 ? hoveredMark.reply + (hoveredMark.reply.length >= 160 ? "…" : "") : "（无回复）"
						})
					]
				}), document.body)]
			});
